...
@Data
@Schema(description = "Request to create a new user task")
public class UserTaskCreateRequest {
    ...
    @Schema(description = "Task priority (1=Lowest, 5=Highest)", example = "3", defaultValue = "3")
    private String priorityId = "3";
